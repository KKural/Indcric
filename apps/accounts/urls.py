...
urlpatterns = [
    ...
    path('profile/username/', views.profile_usernamechange,
         name='profile-usernamechange'),
    path('profile/verify-email/', views.profile_emailverify,
    ...
    path('profile/onboarding/', views.profile_onboarding_view,
         name='profile-onboarding'),
    path('profile/<str:username>/history/<str:tab>/',
         views.profile_history_view, name='profile_history'),
    path('profile/<str:username>/', views.profile_view,
         name='profile_with_username'),

    # User management (staff)
    path('manage/manage-users/',
         views.UsersHtmxTableView.as_view(), name='manage-users'),
    path('manage/users/create/', views.create_user_view, name='create_user'),
    path('manage/users/edit/<int:user_id>/',
         views.edit_user_view, name='edit-user'),
    path('manage/users/delete/<int:user_id>/',
         views.delete_user_view, name='delete_user'),
    path('manage/drink-preferences/', views.bulk_drink_preferences_view,
         name='bulk_drink_preferences'),
]
